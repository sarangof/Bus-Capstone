...
Although demand for public transportation in New York City is growing, bus ridership levels are declining.  Many reasons can explain this, including drops in vehicle speeds and customer perception of dependability.  This project focuses on identifying these two factors along the city's bus routes -operated by the MTA- .

The DOT keeps records of the MTA Bus Time data, but it lacks a formal process for compiling and analysing according to their decision making capabilities, which substantially differ from the MTA's purposes and reach. Despite the MTA (which is the agency in charge of operations) has internally defined metrics used for planning and analysis of buses, it pays more attention to the bus level but not the whole system level, which is more of the interest of the DOT.
