...
To further diagnose the issue, the comparison is made on a finer temporal scale (6-minute timesteps) for a few random dates.  Figure XXX, XXX and XXX show very different patterns when overlaying the level of scheduled activity onto the level of reported activity derived from the Bus Time data.  On one of the two weekdays examined, two large gaps are clearly visible and span the entirety of the two daily “rush-hour” peaks in the schedule.  On the weekend date examined, a short gap is visible in the late evening.
...
\label{week_day}
  ...
  \centering
    \includegraphics[scale=0.6]{/home/saf537/Documents/CUSP/Capstone/Bus-Capstone/plots/interva_distribution}
\end{figure}
