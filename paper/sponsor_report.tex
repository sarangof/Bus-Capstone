...
%  \centering
%    \includegraphics[scale=0.6]{/Users/MISSZHOU/Documents/Bus-Capstone/plots/DOT}
%\end{figure}
...
%  \centering
%    \includegraphics[scale=0.6]{/Users/MISSZHOU/Documents/Bus-Capstone/plots/Spark}
%\end{figure}
...
The data covers a total number of 318 different bus lines and 340 days in a year. So, although this project tried to focus on the whole year data (from 2015-01-01 to 2015-12-31), some days (listed in Figure \ref{m_days}) are entirely missing.
  ...
  \label{m_days}
  \centering
    \includegraphics[scale=0.6]{/Users/MISSZHOU/Documents/Bus-Capstone/plots/missing_days}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \label{m_alldays}
  \centering
    \includegraphics[scale=0.6]{/Users/MISSZHOU/Documents/Bus-Capstone/plots/whole_year_record}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \centering
    \includegraphics[scale=0.6]{/Users/MISSZHOU/Documents/Bus-Capstone/plots/whole_day_record}
\end{figure}
...
\label{b26}
  ...
  \centering
<<<<<<< HEAD
    \includegraphics[scale=0.6]{/Users/MISSZHOU/Documents/Bus-Capstone/plots/trip_coverage_20150106}
=======
    \includegraphics[scale=0.4]{/home/saf537/Documents/CUSP/Capstone/Bus-Capstone/plots/b25_detail}
>>>>>>> 9c5a61f74777da801678ccac90b1e38ae9bfeefd
\end{figure}
...
\label{trip_val}
  ...
  \centering
<<<<<<< HEAD
    \includegraphics[scale=0.6]{/Users/MISSZHOU/Documents/Bus-Capstone/plots/trip_coverage_20151101}
=======
...
\begin{figure}[!ht]
  ...
  \centering
    \includegraphics[scale=0.6]{/Users/MISSZHOU/Documents/Bus-Capstone/plots/trip_coverage_20151203}
\end{figure}
=======
>>>>>>> 9c5a61f74777da801678ccac90b1e38ae9bfeefd
...
\begin{figure}[!ht]
  ...
  \centering
<<<<<<< HEAD
    \includegraphics[scale=0.4]{/Users/MISSZHOU/Documents/Bus-Capstone/plots/running_time_adherence}
=======
...
%  \label{ols}
%  \centering
%    \includegraphics[scale=0.4]{/Users/MISSZHOU/Documents/Bus-Capstone/plots/OLS Regression Results}
%\end{figure}
=======
\begin{figure}[!ht]
  \caption{Correlation of Wait Assessment and Stop Sequence Number.}
  \label{ols}
  \centering
    \includegraphics[scale=1]{/home/saf537/Documents/CUSP/Capstone/Bus-Capstone/plots/ols_summary}
\end{figure}
>>>>>>> 9c5a61f74777da801678ccac90b1e38ae9bfeefd
...
\begin{figure}[!ht]
  ...
  \label{wastop}
  \centering
    \includegraphics[scale=0.4]{/Users/MISSZHOU/Documents/Bus-Capstone/plots/wa_by_stop_sequence}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \label{msd}
  \centering
    \includegraphics[scale=0.45]{/Users/MISSZHOU/Documents/Bus-Capstone/plots/moving_speed_distribution}
\end{figure}
\end{center}
...
\begin{figure}[!ht]
  ...
  \label{adh}
  \centering
    \includegraphics[scale=0.4]{/Users/MISSZHOU/Documents/Bus-Capstone/plots/percent_vehicles_slow_or_stopped}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \centering
    \includegraphics[scale=0.8]{/Users/MISSZHOU/Documents/Bus-Capstone/plots/on_time_performance_stops}
\end{figure}
